...
public class ShortedPolymerFinder {
    public static void main(String[] args) throws IOException {
        ...
        final ForwardsSequentialLoopAlchemicalReducer forwardsSequentialLoopAlchemicalReducer = new ForwardsSequentialLoopAlchemicalReducer();
        for (String charAsString : uppercaseChars) {
            ...
            minLength = Math.min(minLength, forwardsSequentialLoopAlchemicalReducer.reduce(filteredInput).length());
